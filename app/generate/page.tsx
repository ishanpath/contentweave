  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (contentType === "instagram" && image) {
        ...
        promptText +=
          " Describe the image and incorporate it into the caption. Do not list multiple captions, just pick one so the user can copy and paste it.";
      }

      if (contentType === "linkedin") {
        promptText +=
          "Do not list multiple options, choose one. Make it thorough for the user to just copy and paste your output body.";
      }
